  ...
  const features = [
    {
      ...
      styleIfTrue: "text-red-400 bg-red-400/30 hover:border-red-400",
      styleIfFalse: "text-white bg-white/30 hover:border-white ",
      active: isFav,
    },
    {
      label: isLogged ? "Logged!" : "Log a Review",
      icon: MessageSquare,
      action: () => setIsLogged(!isLogged),
      styleIfTrue: "text-orange-300 bg-orange-400/30 hover:border-orange-400",
      styleIfFalse: "text-white bg-white/30 hover:border-white ",
      active: isLogged,
    },
    {
